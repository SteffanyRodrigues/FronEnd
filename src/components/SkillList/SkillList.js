...
import {SkillItem,SkillImage,SkillDetails,SkillName,SkillLevel,SkillDescription,SkillSelect} from './styles';
       ...
       <SkillName>{skill.name}</SkillName>
            ...
            <SkillSelect
              ...
              >
                ...
                {showModal && (
                <Button onClick={() => setShowModal(false)}>Adicionar Mood</Button>
